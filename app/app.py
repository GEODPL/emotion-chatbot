...
def therapeutic_reply(mood, sleep, water, user_text):
    ...
    if "άγχ" in text or "αγχος" in text:
        reply_parts.append(
            "Αναφέρεις άγχος· συχνά το άγχος συνδέεται με πολλές απαιτήσεις που νιώθεις ότι πρέπει να καλύψεις. "
    ...
    if "θλίψ" in text or "στεναχ" in text or "λύπη" in text:
        reply_parts.append(
            "Αναφέρεις θλίψη ή στεναχώρια· αυτά τα συναισθήματα συχνά κρύβουν πίσω τους απογοητεύσεις ή μικρές απώλειες. "
            "Αν νιώθεις έτοιμος/η, μπορείς να μου περιγράψεις τι σε βαραίνει περισσότερο."
        )

    if "μοναξ" in text:
        reply_parts.append(
            "Η μοναξιά μπορεί να είναι πολύ έντονη, ακόμη κι αν υπάρχουν άνθρωποι γύρω σου. "
            "Έχει σημασία να δούμε σε ποιες στιγμές νιώθεις περισσότερο μόνος/η."
        )

    if "πανικ" in text or "κρίση" in text:
        reply_parts.append(
            "Οι κρίσεις πανικού είναι πολύ τρομακτικές την ώρα που συμβαίνουν. "
            "Αν βιώνεις κάτι τέτοιο, είναι σημαντικό να φροντίζεις την αναπνοή σου και, όπου γίνεται, "
            "να ζητάς στήριξη από ανθρώπους εμπιστοσύνης ή και από ειδικό."
        )

    if sleep in ["0–2", "3–5"]:
        reply_parts.append(
            "Βλέπω ότι ο ύπνος σου δεν ήταν αρκετός· η έλλειψη ξεκούρασης μπορεί να κάνει όλα τα συναισθήματα πιο έντονα. "
            "Ίσως μικρές αλλαγές στη ρουτίνα σου να βοηθήσουν λίγο-λίγο."
        )
    elif sleep == "6–8":
        reply_parts.append(
    ...
    if water == "0":
        reply_parts.append(
            "Η πλήρης έλλειψη νερού μέσα στη μέρα επηρεάζει και το σώμα και το μυαλό. "
            "Ίσως ένα μικρό, ρεαλιστικό βήμα θα ήταν να στοχεύσεις σε 1–2 ποτήρια αύριο."
        )
    elif water == "1–3":
        reply_parts.append(
            "Πίνεις λίγο νερό – είναι μια αρχή. "
            "Μπορούμε σιγά-σιγά να στοχεύσουμε λίγο πιο πάνω, αν θέλεις, χωρίς πίεση."
        )
    elif water == "4–6":
        reply_parts.append(
            "Η ενυδάτωσή σου είναι σε καλό επίπεδο· το σώμα σου σίγουρα το εκτιμά, "
            "και αυτό βοηθάει και τη γενικότερη ψυχική αντοχή."
        )
    else:  
        reply_parts.append(
            "Η πολύ καλή ενυδάτωση που έχεις δείχνει ότι φροντίζεις ήδη τον εαυτό σου σε κάποιο βαθμό. "
            "Αυτή η φροντίδα μπορεί να γίνει βάση και για άλλα μικρά βήματα."
        )

    reply_parts.append(
        "Αν νιώθεις άνετα, θα ήθελα να μου πεις λίγο πιο συγκεκριμένα τι θα ήθελες να αλλάξει "
        "ή ποιο είναι το μεγαλύτερο βάρος που κουβαλάς αυτή τη στιγμή."
    )
